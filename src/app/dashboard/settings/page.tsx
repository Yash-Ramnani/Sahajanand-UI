            ...
            <motion.div key="account" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.25 }} className="space-y-8">
                ...
                <div className="flex flex-col md:flex-row items-center gap-8">
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <div className="flex flex-col md:flex-row md:items-center gap-3 mb-2 justify-center md:justify-start">
                      <h2 className="text-3xl font-black text-slate-900">Mukesh Patel</h2>
                    ...
                    <p className="text-slate-500 font-medium mb-6">Parent ID: #P-2024098 • Joined Jan 2026</p>
              ...
              <Tabs defaultValue="account-info" className="w-full space-y-8">
                <TabsList className="bg-slate-50 p-1.5 rounded-2xl border border-slate-100 h-14 flex items-center justify-start gap-1 w-fit">
                  <TabsTrigger value="account-info" className="rounded-xl px-10 h-11 font-bold data-[state=active]:bg-white data-[state=active]:text-indigo-600 data-[state=active]:shadow-sm transition-all">Account Info</TabsTrigger>
                  <TabsTrigger value="my-students" className="rounded-xl px-10 h-11 font-bold data-[state=active]:bg-white data-[state=active]:text-indigo-600 data-[state=active]:shadow-sm transition-all">My Students</TabsTrigger>
                  <TabsTrigger value="notif-prefs" className="rounded-xl px-10 h-11 font-bold data-[state=active]:bg-white data-[state=active]:text-indigo-600 data-[state=active]:shadow-sm transition-all">Notifications</TabsTrigger>
                </TabsList>
                ...
                <CardContent className="p-0 space-y-6">
                  <div className="flex items-center gap-6 p-6 bg-gradient-to-r from-indigo-50 to-violet-50 rounded-2xl border border-indigo-100">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500 font-medium">Grade 10-A • Roll No. 15 • ID: 2024098</p>
                    </div>
                  </div>
              ...
              <Card className="border-none shadow-xl shadow-slate-200/50 rounded-3xl bg-white overflow-hidden p-8">
                ...
                <CardContent className="p-0">
                  <div className="divide-y divide-slate-50">
                    {[
                      { desc: "Premium Parent Plan — Annual", date: "Jan 15, 2026", amount: "₹2,499", status: "Paid" },
                      { desc: "Term 2 Tuition Fee — Vikas Patel", date: "Dec 01, 2025", amount: "₹18,500", status: "Paid" },
                      { desc: "Transport Fee — Route 4", date: "Nov 15, 2025", amount: "₹4,200", status: "Paid" },
                    ].map((tx, i) => (
